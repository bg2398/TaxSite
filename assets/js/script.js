...
const translations = {
  ...
  es: {
    ...
    immigrationApplicationAssistanceText: " Formas N-565, I-130, I-90, N-400, y mas ",
    taxPreparation: "Preparación de Impuestos",
    taxPreparationText: "Personal & Negocios ",
    accountingBookeeping: "Servicios de Contabilidad",
    notaryServices: "Servicios Notarios",
    payrollServicesText: "Servicios de Nomina",
    payrollServices: "Servicios de Nómina",
    Apostille:"Servicios de Apostilla",
    ApostilleText:"Simplificando la legalización de documentos internacionales.",
    arizonaTranslationServices: "Servicios de Traducción en Arizona",
    arizonaTranslationServicesText: "Servicios de Traducción de documentos en Arizona",
    mexicanConsulate: "Asistencia con citas y procesos para el consulado Mexicano",
    mexicanConsulateText: "Asistencia de expertos en la navegación de los procedimientos relacionados con el consulado.",
    realState: "Facilitar transacciones inmobiliarias fluidas con nuestro conocimiento de la industria.",
    realStateText: "Facilitar transacciones inmobiliarias fluidas con nuestro conocimiento de la industria.",
   ...
   footerTranslate: "Únase a nuestra comunidad utilizando nuestros servicios y haga crecer su negocio. Póngase en contacto con nosotros hoy!",
    ...
    resolutionsHeader: "Hacemos que sus necesidades estén libres de estrés.",
    ...
    Callus2: "Issa: (602)-518-6964",
    Callus3: "Horario: Solo con citas.",
  ...
  en: {
    ...
    immigrationApplicationAssistanceText: " Forms N565, I130, I90, N400, and more ",
    taxPreparation: "Tax Preparation",
    taxPreparationText: "Personal & Business ",
    accountingBookeeping: "Accounting & Bookeeping services",
    notaryServices: "Notary Services",
    payrollServices: "Payroll Services",
    payrollServicesText: "Streamlining payroll processes for efficiency and compliance.",
    arizonaTranslationServices: "Arizona Translation Services",
    Apostille:"Apostille Services",
    ApostilleText:"Simplifying the legalization of international documents.",
    arizonaTranslationServicesText: "Document translation services.",
    mexicanConsulate:"Assistance with Mexican consulate appointments and services. ",
    mexicanConsulateText: "Expert assistance in navigating consulate-related procedures.",
    realState: "Facilitating smooth real estate transactions with our industry insight.",
    realStateText: "Facilitating smooth real estate transactions with our industry insight.",
    ...
    resolutionsHeader: "We make your needs stress-free.",
    ...
    Callus: "Llamanos: Iris: (602)-446-3836",
    Callus2: "Issa: (602)-518-6964",
    Callus3: "Hours of operation: By appoitnment only",
